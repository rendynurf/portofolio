const SCRIPT_URL = 'https://script.google.com/macros/s/AKfycbzQ-E5nkPAlhCDBdLDKnwHTBBXV0QCCQcsezkR5hofbvKQkJJnpuibcmR9IwbY_p3dB/exec'; 
...
function renderPortfolio(data) {
    ...
    const createGalleryCard = (item, isClickable = true) => {
        const img = convertToDirectLink(item.ImageURL) || 'image/rnf.png'; // Atau bisa dikosongkan ''
